      ...
      <div className="fixed inset-x-0 top-4 z-50 flex justify-center px-4">
        ...
        >
          ...
          <div className="flex items-center gap-2">
            ...
            <Link
              to="/contact"
              className="hidden items-center gap-2 rounded-full bg-gold px-4 py-2 text-sm font-semibold text-primary-foreground shadow-gold btn-silver md:inline-flex"
            >
        ...
        <div className="fixed inset-x-4 top-24 z-40 glass rounded-3xl p-4 md:hidden">
          <ul className="flex flex-col gap-1">
            ...
            <li className="mt-1">
              <Link
                to="/contact"
                className="flex w-full items-center justify-center gap-2 rounded-full bg-gold px-4 py-3 text-sm font-semibold text-primary-foreground btn-silver"
              >
